...
export class Init1769959224301 implements MigrationInterface {
    name = 'Init1769959224301'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "email_templates" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "template_id" character varying NOT NULL, "userId" uuid, CONSTRAINT "UQ_7df8a0c6b71357f6a622aad4899" UNIQUE ("template_id"), CONSTRAINT "REL_852f7f5b1c08289d94df1b05fb" UNIQUE ("userId"), CONSTRAINT "PK_06c564c515d8cdb40b6f3bfbbb4" PRIMARY KEY ("id"))`);
